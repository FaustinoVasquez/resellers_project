<div class="row">
          ...
          {!! Form::open(array('route' => 'pBySkuSearch','method'=>'get','id'=>'myForm','class'=>'ajax')) !!}
          ...
          <div class="form-group col-sm-2">
            <div class="input-group">
                ...
                {!! Form::text('DateFrom', $from, ['id' =>'datefrom','class' => 'datePicker form-control','maxlength'=>'10','size'=>'7' ]) !!}
            </div>
          </div>
          ...
          <div class="form-group col-sm-2">
            <div class="input-group">
                ...
                {!! Form::text('DateTo', $to, ['id' =>'dateto','class' => 'datePicker form-control','maxlength'=>'10','size'=>'7']) !!}
            </div>
          </div>
