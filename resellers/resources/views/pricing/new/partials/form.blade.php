<div class="row">
        {!! Form::open(array('route' => 'otherSearch','method'=>'get','id'=>'myForm','class'=>'ajax')) !!}
...
{{--                 <i class="fa fa-check-square-o"></i>--}}
{{--             </span>--}}
{{--            {!! Form::select('Manufacturers', $manufacturers, null, array('id' =>'manufacturers','class' => 'form-control')) !!}--}}
{{--        </div>--}}
{{--    </div>--}}

      <div class="form-group col-sm-4 col-md-3 col-lg-2">
          <button class="btn btn-primary btn-block visible-xs btn-bottom-margin-10">Submit</button>
        {!! Form::submit('Submit', array('class' => 'btn btn-primary btn-fill hidden-xs')) !!}
        {!! Form::close() !!}
      </div>
</div>
